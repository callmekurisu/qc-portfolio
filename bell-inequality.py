""" Create a Bell Inequality circuit """
...
def make_bell_test_circuit():
    # Qubits for Alice, Bob and referee
    ...
    # Prepare shared Alice-Bob entangled state
    circuit.append([
        cirq.H(alice),
        cirq.CNOT(alice, bob),
        cirq.X(alice) **-0.25
    ...
    # Players do sqrt X based on respective Ref's coin
    circuit.append([
